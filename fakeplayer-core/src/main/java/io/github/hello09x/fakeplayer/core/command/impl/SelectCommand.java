...
public class SelectCommand extends AbstractCommand {
    ...
    public void select(@NotNull Player sender, @NotNull CommandArguments args) {
        ...
        if (target == null) {
            sender.sendMessage(translatableWithPrefix("fakeplayer.command.select.success.clear", GRAY));
        } else {
    ...
    public void selection(@NotNull Player sender, @NotNull CommandArguments args) {
        ...
        if (selection == null) {
            sender.sendMessage(translatableWithPrefix("fakeplayer.command.selection.error.none", GRAY));
        } else {
            sender.sendMessage(translatableWithPrefix(
